 ...
 * 购物车适配器
 */
public class ShopCat1Adapter extends BaseExpandableListAdapter {
    ...
    ShopCat1Adapter(List<StoreInfo> groups, Map<String, List<GoodsInfo>> children, Context mContext) {
        this.groups = groups;
